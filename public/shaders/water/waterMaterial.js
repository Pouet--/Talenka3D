...
(function () {
    WORLDMONGER.WaterMaterial = function (name, scene, light) {
		...
		// Bump texture
        this.bumpTexture = new BABYLON.Texture("js/shaders/water/bumpTexture.png", scene);
		...
		// Reflection texture --> simulate a mirror 
	...
	// MUST retrieve and use  the BABYLON.Material prototype
